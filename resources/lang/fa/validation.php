...
return [
    ...
    */
    ...
    'smaller_than_field' => 'گزینه ی ":attribute" باید کوچکتر و یا مساوی ":field" باشد',
    'greater_than_field' => 'گزینه ی ":attribute" باید بزرگتر و یا مساوی ":field" باشد',
    'not_if_field_is' => 'گزینه ی ":attribute" در صورتی مورد پذیرش است که ":field" مناسب باشد',
    'true_if_field_is' => 'گزینه ی ":attribute" در صورتی مورد پذیرش است که ":field" مناسب باشد',
    'required' => 'فیلد :attribute الزامی است',
    'national_code' => ' :attribute باید یک کد ملی صحیح باشد',
    'required_if' => 'با توجه به گزینه ی  ":other" ، فیلد ":attribute" الزامی است.',
    ...
    */
    ...
    'custom' => [
        //
        'The given data was invalid.' => 'اطلاعات وارد شده غلط است.'
    ],
    /*
    |--------------------------------------------------------------------------
